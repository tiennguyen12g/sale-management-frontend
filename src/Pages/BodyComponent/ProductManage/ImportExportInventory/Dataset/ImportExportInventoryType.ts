...
const imports: ImportType[] =  dataTestInput.imports;
const exports: ExportType[] = dataTestInput.exports;
const inventory: InventoryType[] = dataTestInput.inventory;

export {
  imports, exports, inventory
}
