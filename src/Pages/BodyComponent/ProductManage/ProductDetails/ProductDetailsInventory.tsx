...
import styles from "./ProductDetailsInventory.module.scss";
...
export default function ProductDetailsInventory({ showForm, setShowForm }: Props) {
  ...
  return (
    <div className={cx("product-details")}>
      ...
      <div className={cx("product-list")}>
        ...
        <ProductTableInventory products={products} onEdit={handleEdit} onDelete={handleDelete} />
      </div>
    </div>
  );
}
