...
export default function Box({ titleBox, arrayData, arrayCardInfos, boxType, setBankEditData, setIsShowEditBankBox, isOneWayAccount }: Props) {
            ...
            return (
              <div key={i} className={cx("segment-data")}>
                <div>
                  ...
                  <div style={{ textDecoration: isOneWayAccount ? "line-through" : "" }}>{item.value.toLocaleString("vi-VN")}₫</div>
                </div>
            ...
            return (
              <div key={i} className={cx("segment-data")}>
                <div>
                  ...
                  <div style={{ textDecoration: isOneWayAccount ? "line-through" : "" }}>{cardInfos.balance.toLocaleString("vi-VN")}₫</div>
                </div>
                {isShowVerticalLine && <div className={cx("vertical-line")}></div>}
                {cardInfos && (
