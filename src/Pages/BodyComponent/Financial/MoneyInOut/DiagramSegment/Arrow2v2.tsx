...
export default function Arrow2v2({
  arrowAngle = 0,
  arrowText = "",
  arrowValue = 0,
  arrowColor,
  ...
  const markerId = `arrowheadv2-${arrowText.replace(/\s+/g, "-")}-${arrowColor}`;
    ...
    <div className={cx("wrapper")}>
      <svg className={cx("arrows")}>
        ...
        {/* Arrow line */}
          ...
          markerEnd={`url(#${markerId})`}
          transform={`rotate(${arrowAngle}, 9.5, 10)`}
          stroke={arrowColor}
          strokeWidth={2}
        />
        ...
        {/* Labels */}
        <text x="30" y="60" style={{ fontSize: 16 }}>
          {arrowText}
        </text>
        <text x="30" y="90" style={{ fontSize: 16 }}>
