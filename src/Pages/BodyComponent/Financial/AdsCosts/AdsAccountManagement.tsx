            ...
            <div className={cx("table-container")}>
              ...
              <div className={cx("table-body")}>
                {adsTest.map((adsInfo, i) => {
                  const shortPaymentCardNumber = adsInfo.paymentMethod.card_number.toString().split("").slice(-4).join("");
                  return (
                    <div className={cx("table-row")} key={i}>
                      ...
                      <div className={cx("table-cell")}>
                        {adsInfo.paymentMethod.card_type === "Mastercard" && <img src={mastercardIcon} alt="mastercard"/>}
                         {adsInfo.paymentMethod.card_type === "Visa" && <FaCcVisa size={24}/>}
                        <span>-{shortPaymentCardNumber}</span>
                      </div>
